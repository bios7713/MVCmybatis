...
생년월일  : <fmt:formatDate value="${memberCommand.userBirth}" type="date" pattern="yyyyMMdd"/>	<br />
...
등록일 : 
<fmt:formatDate value="${memberCommand.userRegist}" type="date" pattern="yyyyMMdd"/>	
						<br />
